...
let mapGenerator = function () {
  ...
  do {
    ...
    if (j === 0) {
      ...
      ok = writer.write({
        restaurant_id: j,
        latitude: rando(47606, 32715) * .001, // North South Seat (47.606) - SD (32.715);
        longitude: rando(74005, 122419) * -.001, //  East West  NYC (-74.005) - SF (-122.419);
      });
    }
  } while (j > 0 && ok);
  if (j > 0) {
